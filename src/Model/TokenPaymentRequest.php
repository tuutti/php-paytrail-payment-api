...
/**
 * TokenPaymentRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class TokenPaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TokenPaymentRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('invoicing_address', $data ?? [], null);
    ...
    */
    ...
    public function setStamp($stamp)
    {
        ...
        if ((mb_strlen($stamp) > 200)) {
            throw new \InvalidArgumentException('invalid length for $stamp when calling TokenPaymentRequest., must be smaller than or equal to 200.');
        }
    ...
    public function setReference($reference)
    {
        ...
        if ((mb_strlen($reference) > 200)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling TokenPaymentRequest., must be smaller than or equal to 200.');
        }
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount > 99999999)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling TokenPaymentRequest., must be smaller than or equal to 99999999.');
        }
        if (($amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling TokenPaymentRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setOrderId($order_id)
    {
        ...
        if ((mb_strlen($order_id) > 60)) {
            throw new \InvalidArgumentException('invalid length for $order_id when calling TokenPaymentRequest., must be smaller than or equal to 60.');
        }
    ...
    {
        if (is_null($invoicing_address)) {
            throw new \InvalidArgumentException('non-nullable invoicing_address cannot be null');
        }
    ...
    {
        if (is_null($callback_delay)) {
            throw new \InvalidArgumentException('non-nullable callback_delay cannot be null');
        }

        if (($callback_delay > 900)) {
            throw new \InvalidArgumentException('invalid value for $callback_delay when calling TokenPaymentRequest., must be smaller than or equal to 900.');
        }
        if (($callback_delay < 0)) {
            throw new \InvalidArgumentException('invalid value for $callback_delay when calling TokenPaymentRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets token
     *
     * @param string $token Payment card token received from request to /tokenization/{checkout-tokenization-id}
     *
     * @return self
     */
