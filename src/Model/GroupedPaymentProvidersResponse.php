...
/**
 * GroupedPaymentProvidersResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class GroupedPaymentProvidersResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GroupedPaymentProvidersResponse';
    ...
    protected static $openAPITypes = [
        'terms' => 'string',
        'groups' => '\Paytrail\Payment\Model\PaymentMethodGroupDataWithProviders[]',
     ...
     * Sets terms
     *
     * @param string $terms Localized text with a link to payment terms
     *
     * @return self
     */
     ...
     * Gets groups
     *
     * @return \Paytrail\Payment\Model\PaymentMethodGroupDataWithProviders[]
     */
     ...
     * Sets groups
     *
     * @param \Paytrail\Payment\Model\PaymentMethodGroupDataWithProviders[] $groups Payment method group data for all of groups that are included in the query
     *
     * @return self
     */
     ...
     * Sets providers
     *
     * @param \Paytrail\Payment\Model\PaymentMethodProvider[] $providers A flat list of payment method providers
     *
     * @return self
     */
