...
class PaymentReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const PAYMENT_STATUS__DEFAULT = 'default';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['payment_status'] = $data['payment_status'] ?? PAYMENT_STATUS__DEFAULT;
        $this->container['start_date'] = $data['start_date'] ?? null;
        $this->container['end_date'] = $data['end_date'] ?? null;
        $this->container['limit'] = $data['limit'] ?? 50000;
