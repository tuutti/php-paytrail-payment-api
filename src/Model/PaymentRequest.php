...
class PaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
		...
		'manual_invoice_activation' => false,
		'redirect_urls' => false,
		'callback_urls' => false,
    ...
    public const GROUPS_MOBILE = 'mobile';
    public const GROUPS_BANK = 'bank';
    public const GROUPS_CREDITCARD = 'creditcard';
    public const GROUPS_CREDIT = 'credit';
    public const GROUPS_OTHER = 'other';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('manual_invoice_activation', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($manual_invoice_activation)) {
            throw new \InvalidArgumentException('non-nullable manual_invoice_activation cannot be null');
        }
    ...
    public function setGroups($groups)
    {
        ...
        if (array_diff($groups, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
