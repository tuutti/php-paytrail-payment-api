...
/**
 * TokenCustomerDetails Class Doc Comment
 *
 * @category Class
 * @package  Paytrail\Payment
 * @author   OpenAPI Generator team
 ...
 */
class TokenCustomerDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TokenCustomerDetails';
    ...
    {
        $this->setIfExists('network_address', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['network_address'] === null) {
            $invalidProperties[] = "'network_address' can't be null";
        }
     ...
     *
     * @param string $network_address Customer IP address
     *
     * @return self
     */
    public function setNetworkAddress($network_address)
    {
        if (is_null($network_address)) {
            throw new \InvalidArgumentException('non-nullable network_address cannot be null');
        }
